...
We remove the year based on our selection, which causes the filter to become ineffective, resulting in a broken code. However, since the budget remains in the data after the select code, the drop_na function for budget may still work.
...
"The oldest film is 'Blacksmith Scene' from 1893, while the longest is 'The Cure for Insomnia.'"
...
movies_Ques1
```
There were 1248 movies released in 1995.  
...
"The films 'Big Fish,' 'Forrest Gump,' 'The Man Who Copied' ('Homem Que Copiava'), and 'The Incredibles' were shown."
...
This dataset features three films: Harry Potter and the Sorcerer's Stone, Harry Potter and the Chamber of Secrets, and Harry Potter and the Prisoner of Azkaban. Among them, Harry Potter and the Prisoner of Azkaban has the highest rating, while Harry Potter and the Sorcerer's Stone is the most-voted Harry Potter film."
...
With at least 100 votes, Wild Wild West has the highest budget of any comedy or animated film
